...
*Versión 1.0 — Julio 2026. Este archivo se despliega junto a `protocolo-loop-cursor.md`
como regla de Cursor y se referencia desde los master prompts de los agentes GPT.*
